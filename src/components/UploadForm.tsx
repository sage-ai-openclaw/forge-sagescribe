...
import { Upload, Loader2, Check, Copy, Download } from 'lucide-react';
...
export function UploadForm() {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <form onSubmit={handleSubmit} className="bg-slate-900/50 border border-slate-800 rounded-2xl p-8">
